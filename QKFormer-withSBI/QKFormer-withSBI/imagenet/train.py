...
def main(args):
    ...
    dataset_train=SBI_Dataset(phase='train',image_size=384)
    dataset_val=SBI_Dataset(phase='val',image_size=384)
    ...
    print(f"Start training for 100 epochs")
    ...
    for epoch in range(args.start_epoch, 100):
        ...
        if epoch > int(100 - 20) and test_stats["acc1"] > max_accuracy:
            if args.output_dir:
                misc.save_model(
